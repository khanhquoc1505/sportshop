<table class="w-full table-auto">
  ...
  <div class="flex space-x-2">
    @php
      // lấy đúng tập ảnh của variant: cùng màu + cùng size
      $imgs = $v->product
                ->colorImages
                ->where('mausac_id', $v->mausac_id)
                ->where('kichco_id', $v->kichco_id);
    @endphp
...
/>
    ...
    @endif
      ...
      <a href="{{ route('admin.variant.edit', $v->id) }}" class="px-3 py-1 bg-yellow-400 text-white rounded">Sửa</a>
