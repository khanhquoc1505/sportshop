...
<div class="flex flex-wrap gap-3 items-center mb-6">
  <input id="feedbackSearch" type="text" placeholder="Tìm kiếm ID, sản phẩm, khách..." class="px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-primary w-64" />
